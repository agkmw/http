...
func TestRequestLineParse(t *testing.T) {
	...
	r, err = RequestFromReader(strings.NewReader("PUT / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.NoError(t, err)
	require.NotNil(t, r)
...
func TestHeadersParse(t *testing.T) {
	...
	r, err = RequestFromReader(reader)
	require.NoError(t, err)
	require.Equal(t, headers.Headers{}, r.Headers)
	...
	r, err = RequestFromReader(reader)
	require.NoError(t, err)
	require.Equal(t, "localhost:42069, google.com", r.Headers["host"])
